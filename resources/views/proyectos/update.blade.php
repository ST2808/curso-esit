...
@section('content')
    <form action="{{ route('putProyectos', $proyecto)}}" method="POST" enctype="multipart/form-data">
        @method('post')
        @csrf
        ...
        <div class="row mt-4">
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <input name="NombreProyecto" type="text" class="form-control" id="NombreProyecto" aria-describedby="text" @error('NombreProyecto') class="border border-danger" @enderror value="{{old('NombreProyecto', $proyecto->NombreProyecto)}}">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <input name="FuenteFondos" type="text" class="form-control" id="FuenteFondos" aria-describedby="FuenteFondos" @error('FuenteFondos') class="border border-danger" @enderror value="{{ old('FuenteFondos', $proyecto->FuenteFondos) }}">
                @error('FuenteFondos')
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <textarea name="descripcion" type="text" class="form-control" id="descripcion" @error('descripcion') class="border border-danger" @enderror>{{old('descripcion', $proyecto->descripcion)}}</textarea >
                @error('descripcion')
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <input name="MontoPlanificado" type="number" class="form-control" id="MontoPlanificado" aria-describedby="MontoPlanificado" @error('MontoPlanificado') class="border border-danger" @enderror value="{{old('MontoPlanificado', $proyecto->MontoPlanificado)}}">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <input name="MontoPatrocinado" type="number" class="form-control" id="MontoPatrocinado" @error('MontoPatrocinado') class="border border-danger" @enderror value="{{old('MontoPatrocinado', $proyecto->MontoPatrocinado)}}">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <input name="MontoFondosPropios" type="number" class="form-control" id="MontoFondosPropios" @error('MontoFondosPropios') class="border border-danger" @enderror value="{{old('MontoFondosPropios', $proyecto->MontoFondosPropios)}}">
